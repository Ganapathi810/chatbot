    ...
    <div className={inputContainerClass}>
      <div className={`w-full max-w-4xl mx-auto px-2 sm:px-0 ${!hasMessages ? 'animate-fade-in' : ''}`}>
        ...
        <form onSubmit={handleSubmit} className="relative">
          <div className={`relative bg-gray-800/50 backdrop-blur-sm rounded-xl sm:rounded-2xl border transition-all duration-500 ${
            isFocused 
            ...
            <button
              ...
              className="absolute right-2 sm:right-3 bottom-2 sm:bottom-3 p-2 sm:p-3 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 disabled:from-gray-600 disabled:to-gray-700 text-white rounded-lg sm:rounded-xl transition-all duration-200 hover:scale-105 hover:shadow-lg hover:shadow-orange-500/25 disabled:hover:scale-100 disabled:hover:shadow-none"
            >
